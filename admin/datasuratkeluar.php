        ...
        <div class="">
          <div class="page-title">
            <div class="title_right">
              <h2>LAPORAN ><small> Data Laporan</small></h2>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Data Laporan<small></small></h2>
                  <div class="clearfix"></div>
                </div>
                <form action="downloadlaporan_suratkeluar.php" name="download_suratkeluar" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  ...
                  <button type="submit" class="btn btn-success"><i class="fa fa-download"></i> Unduh Laporan per Bulan</button></a>
                  <a href="inputsuratkeluar.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Laporan</button></a>
                </form>
                <div class="x_content">
                  <div class="x_content">
                    <?php
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th width="14%">SPPD</th>
                            <th width="10%">Nomor LHP</th>
                            <th width="9%">Tanggal LHP</th>
                            <th width="10%">Inspektorat</th>
                            <th width="9%">Jenis Laporan</th>
                            <th width="9%">Perangkat</th>
                            <th width="15%">Jenis Tugas</th>
                            <th width="12%">Alamat Penerima</th>
                            <th width="10%">Aksi</th>
                          </tr>
                        </thead>
