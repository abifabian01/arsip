                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <table class="table table-striped">
                      <tbody>
                        ...
                        <tr>
                          <td>Inspektorat</td>
                          <td><?php echo $data['inspektorat'] ?></td>
                        </tr>
                        <tr>
                          <td>Jenis Laporan</td>
                        ...
                        <tr>
                          <td>Ketua Tim</td>
                          <td><?php echo $data['ketuatim'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 1</td>
                          <td><?php echo $data['anggota1'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 2</td>
                          <td><?php echo $data['anggota2'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 3</td>
                          <td><?php echo $data['anggota3'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 4</td>
                          <td><?php echo $data['anggota4'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 5</td>
                          <td><?php echo $data['anggota5'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 6</td>
                          <td><?php echo $data['anggota6'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 7</td>
                          <td><?php echo $data['anggota7'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 8</td>
                          <td><?php echo $data['anggota8'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 9</td>
                          <td><?php echo $data['anggota9'] ?></td>
                        </tr>
                        <tr>
                          <td>Anggota 10</td>
                          <td><?php echo $data['anggota10'] ?></td>
                        </tr>
                        <tr>
                          <td>Perihal</td>
                          <td><?php echo $data['jenis_tugas'] ?></td>
                        </tr>
                        <tr>
