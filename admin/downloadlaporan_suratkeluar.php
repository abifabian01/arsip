...
$excelku->getActiveSheet()->setCellValue('A2', "PEMERINTAH KABUPATEN ROTE NDAO");
$excelku->getActiveSheet()->mergeCells('A3:H3');
$excelku->getActiveSheet()->setCellValue('A3', "INSPEKTORAT");
$excelku->getActiveSheet()->mergeCells('A4:H4');
$excelku->getActiveSheet()->setCellValue('A4', "Kompleks Perkantoran Bumi Ti'i Langga Permai, Jln Lekunik-Baa Telp/Fax (0380)8571095");
$excelku->getActiveSheet()->mergeCells('A5:H5');
$excelku->getActiveSheet()->setCellValue('A5', "DATA SURAT KELUAR BULAN $bulan TAHUN $tahun");
...
$SI->setCellValue('A8', "NOMOR ");
$SI->setCellValue('B8', "TANGGAL KELUAR");
$SI->setCellValue('C8', "NAMA/NIP");
$SI->setCellValue('D8', "SPPD");
$SI->setCellValue('E8', "NOMOR BERKAS");
$SI->setCellValue('F8', "TANGGAL LHP");
$SI->setCellValue('G8', "JENIS TUGAS");
$SI->setCellValue('H8', "ALAMAT PENERIMA");
...
while ($data = $query1->fetch_assoc()) {
  $SI->setCellValue("A" . $baris, $data['nomor_suratkeluar']);
  $SI->setCellValue("B" . $baris, $data['tanggalkeluar_suratkeluar']);
  $SI->setCellValue("C" . $baris, $data['nama_nip']);
  $SI->setCellValue("D" . $baris, $data['sppd']);
  $SI->setCellValue("E" . $baris, $data['no_berkas']);
  $SI->setCellValue("F" . $baris, $data['tanggalsurat_suratkeluar']);
  $SI->setCellValue("G" . $baris, $data['jenis_tugas']);
  $SI->setCellValue("H" . $baris, $data['alamat']);
